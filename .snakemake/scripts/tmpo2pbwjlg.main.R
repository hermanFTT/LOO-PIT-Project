...
snakemake <- Snakemake(
    input = list(),
    output = list('results/results-varying_nu-student_t-df_9999-beta_9999-n_256.rds', 'results/rates-varying_nu-student_t-df_9999-beta_9999-n_256.rds', "output_file" = 'results/results-varying_nu-student_t-df_9999-beta_9999-n_256.rds', "rates_file" = 'results/rates-varying_nu-student_t-df_9999-beta_9999-n_256.rds'),
    params = list(200L, 15L, "nsims" = 200L, "nbins" = 15L),
    wildcards = list('varying_nu', 'student_t', '9999', '9999', '256', "style" = 'varying_nu', "dgp" = 'student_t', "df" = '9999', "beta" = '9999', "n" = '256'),
    threads = 1,
    log = list(),
    ...
    scriptdir = '/u/84/tessoh1/data/Desktop/Git Repositories/LOO-PIT-Project',
    source = function(...){
        old_wd <- getwd()
